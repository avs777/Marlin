...
namespace LanguageNarrow_en {
  ...
  LSTR MSG_BLTOUCH                        = _UxGT("CRTouch"); // AVS
  ...
  LSTR MSG_BLTOUCH_MODE_STORE_5V          = _UxGT("Set CRTouch to 5V"); // AVS
  LSTR MSG_BLTOUCH_MODE_STORE_OD          = _UxGT("Set CRTouch to OD"); // AVS
