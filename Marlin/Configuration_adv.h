 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD        100 // (seconds) // AVS
  #define THERMAL_PROTECTION_HYSTERESIS     10 // (°C) // AVS

  #define ADAPTIVE_FAN_SLOWING              // Slow down the part-cooling fan if the temperature drops // AVS
  #if ENABLED(ADAPTIVE_FAN_SLOWING)
    #define REPORT_ADAPTIVE_FAN_SLOWING     // Report fan slowing activity to the console // AVS
    #if ANY(MPCTEMP, PIDTEMP)
      #define TEMP_TUNING_MAINTAIN_FAN      // Don't slow down the fan speed during M303 or M306 T // AVS
    #endif
  #endif
...
#define SHOW_TEMP_ADC_VALUES // AVS
...
#define HOTEND_IDLE_TIMEOUT
  ...
  #define HOTEND_IDLE_TIMEOUT_SEC (10*60)    // (seconds) Time without extruder movement to trigger protection  // AVS
  #define HOTEND_IDLE_MIN_TRIGGER   195     // (°C) Minimum temperature to enable hotend protection  // AVS
 ...
 */
#define USE_CONTROLLER_FAN // AVS
#if ENABLED(USE_CONTROLLER_FAN)
  #define CONTROLLER_FAN_PIN PB15           // Set a custom pin for the controller fan // AVS
  ...
  #define CONTROLLER_FAN_EDITABLE         // Enable M710 configurable settings // AVS
 ...
 */
#define E0_AUTO_FAN_PIN PC7 // AVS
...
// @section bltouch
   ...
   */
  #define BLTOUCH_HS_MODE true  // AVS
...
//#define ASSISTED_TRAMMING
   ...
   */
  #define TRAMMING_SCREW_THREAD M4_CW // AVS
...
// #define INPUT_SHAPING_Z // AVS
  ...
  #define SHAPING_MENU                // Add a menu to the LCD to set shaping parameters. // AVS
#endif
 ...
 */
#define ADAPTIVE_STEP_SMOOTHING // AVS
 ...
 */
  ...
  #define PROBE_OFFSET_WIZARD // AVS
     ...
     */
    #define PROBE_OFFSET_WIZARD_START_Z -4.0 // AVS

    // Set a convenient position to do the calibration (probing point and nozzle/bed-distance)
    #define PROBE_OFFSET_WIZARD_XY_POS { X_CENTER, Y_CENTER } // AVS
  #endif
#endif
  ...
  #define SHOW_BOOTSCREEN                 // Show the Marlin bootscreen on startup. ** ENABLE FOR PRODUCTION **
    ...
    #define BOOTSCREEN_TIMEOUT 3000       // (ms) Total Duration to display the boot screen(s)
      ...
      //#define SHOW_CUSTOM_BOOTSCREEN    // Show the bitmap in Marlin/_Bootscreen.h on startup.  // AVS
    #endif
  #endif

  #if HAS_MARLINUI_U8GLIB
    #define CUSTOM_STATUS_SCREEN_IMAGE  // Show the bitmap in Marlin/_Statusscreen.h on the status screen. // AVS
  #endif

  #define SOUND_MENU_ITEM   // Add a mute option to the LCD menu // AVS
  ...
  #define STATUS_MESSAGE_SCROLLING // AVS
...
#define SET_PROGRESS_MANUALLY // AVS
#if ENABLED(SET_PROGRESS_MANUALLY)
  #define SET_PROGRESS_PERCENT            // Add 'P' parameter to set percentage done
  #define SET_REMAINING_TIME              // Add 'R' parameter to set remaining time
  //#define SET_INTERACTION_TIME          // Add 'C' parameter to set time until next filament change or other user interaction
  #define M73_REPORT                    // Report M73 values to host // AVS
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define SHOW_REMAINING_TIME           // Display estimated time to completion (prefix 'R') // AVS
  ...
  //#define PRINT_PROGRESS_SHOW_DECIMALS  // Show/report progress with decimal digits, not all UIs support this
    ...
    #define LCD_PROGRESS_BAR            // Show a progress bar on HD44780 LCDs for SD printing // AVS
  ...
  #define SD_FINISHED_RELEASECOMMAND "M84XYE"  // Use "M84XYE" to keep Z enabled so your bed stays in place // AVS
  ...
  // SD Card Sorting options
    ...
    #define SDSORT_USES_RAM    true   // Pre-allocate a static array for faster pre-sorting.  // AVS
    #define SDSORT_USES_STACK  false  // Prefer the stack for pre-sorting to give back some SRAM. (Negated by next 2 options.)
    #define SDSORT_CACHE_NAMES true   // Keep sorted items in RAM longer for speedy performance. Most expensive option.  // AVS
    #define SDSORT_DYNAMIC_RAM true  // Use dynamic allocation (within SD menus). Least expensive option. Set SDSORT_LIMIT before use!  // AVS
  ...
  #define UTF_FILENAME_SUPPORT // AVS

  #define LONG_FILENAME_HOST_SUPPORT    // Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L' // AVS
  //#define LONG_FILENAME_WRITE_SUPPORT   // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol
  //#define M20_TIMESTAMP_SUPPORT         // Include timestamps by adding the 'T' flag to M20 commands

  #define SCROLL_LONG_FILENAMES         // Scroll long filenames in the SD card menu // AVS
  ...
  #define AUTO_REPORT_SD_STATUS         // Auto-report media status with 'M27 S<seconds>' // AVS
  ...
  #define BINARY_FILE_TRANSFER  // AVS
   ...
   */
  #define SDCARD_CONNECTION ONBOARD // AVS
 ...
 */
#define BABYSTEPPING // AVS
#if ENABLED(BABYSTEPPING)
  //#define EP_BABYSTEPPING                 // M293/M294 babystepping with EMERGENCY_PARSER support
  #define BABYSTEP_WITHOUT_HOMING           // AVS
  #define BABYSTEP_ALWAYS_AVAILABLE         // Allow babystepping at all times (not just during movement) // AVS
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // Double-click on the Status Screen for Z Babystepping. // AVS
  ...
  #define BABYSTEP_DISPLAY_TOTAL          // Display total babysteps since last G28  // AVS

  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping  // AVS

  #if ENABLED(BABYSTEP_ZPROBE_OFFSET)
    //#define BABYSTEP_HOTEND_Z_OFFSET      // For multiple hotends, babystep relative Z offsets
    #define BABYSTEP_GFX_OVERLAY          // Enable graphical overlay on Z-offset editor // AVS
  #endif
#endif
...
#define LIN_ADVANCE  // AVS
  ...
  #else
    // set "0" for disables the hard-coded firmware value. In this case only the K-Factor set via the filament g-code "M900 Kxx" is used.
    #define ADVANCE_K 0.0 //0.22  // (mm) Compression length applying to all extruders  // AVS
  #endif
...
#define SERIAL_FLOAT_PRECISION 4 // AVS
...
#define FWRETRACT  // AVS
  ...
  #define RETRACT_FEEDRATE             85   // (mm/s) Default feedrate for retracting
 ...
 */
#define ADVANCED_PAUSE_FEATURE  // AVS
  ...
  #define PARK_HEAD_ON_PAUSE                      // Park the nozzle during pause and filament change. // AVS
  //#define HOME_BEFORE_FILAMENT_CHANGE           // If needed, home before parking for filament change

  #define FILAMENT_LOAD_UNLOAD_GCODES             // Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu. // AVS
 ...
 */
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // All axes (override below) // AVS
   ...
   */
  #define MONITOR_DRIVER_STATUS // AVS
   ...
   */
  #define HYBRID_THRESHOLD // AVS

  #define X_HYBRID_THRESHOLD     100  // [mm/s]
  #define X2_HYBRID_THRESHOLD    100
  #define Y_HYBRID_THRESHOLD     100
  #define Y2_HYBRID_THRESHOLD    100
  #define Z_HYBRID_THRESHOLD      20 // AVS
 ...
 */
#define M114_DETAIL         // Use 'M114` for details to check planner calculations // AVS
...
#define REPORT_FAN_CHANGE   // Report the new fan speed when changed by M106 (and others) // AVS
 ...
 */
#define AUTO_REPORT_POSITION // AVS
...
#define CAPABILITIES_REPORT
  ...
  #define EXTENDED_CAPABILITIES_REPORT
    ...
    #define M115_GEOMETRY_REPORT // AVS
  #endif
#endif
...
//#define CUSTOM_MENU_MAIN
  ...
  // #define MAIN_MENU_ITEM_6_DESC "Fan on"  // AVS
  // #define MAIN_MENU_ITEM_6_GCODE "M106 S255"  // AVS
  // //#define MAIN_MENU_ITEM_6_CONFIRM  // AVS

  // #define MAIN_MENU_ITEM_6_DESC "Fan off"  // AVS
  // #define MAIN_MENU_ITEM_6_GCODE "M107"  // AVS
  // //#define MAIN_MENU_ITEM_3_CONFIRM  // AVS
#endif
 ...
 */
#define HOST_ACTION_COMMANDS  // AVS
#if ENABLED(HOST_ACTION_COMMANDS)
  #define HOST_PAUSE_M76                // Tell the host to pause in response to M76  // AVS
  #define HOST_PROMPT_SUPPORT           // Initiate host prompts to get user feedback  // AVS
  #if ENABLED(HOST_PROMPT_SUPPORT)
    #define HOST_STATUS_NOTIFICATIONS   // Send some status messages to the host as notifications  // AVS
  #endif
  #define HOST_START_MENU_ITEM          // Add a menu item that tells the host to start  // AVS
  #define HOST_SHUTDOWN_MENU_ITEM       // Add a menu item that tells the host to shut down  // AVS
#endif
