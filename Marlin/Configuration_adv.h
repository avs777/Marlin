...
#define FT_MOTION  // AVS
  ...
  #define FTM_SHAPER_E                        // Include E shaping support   // AVS
...
// #define LIN_ADVANCE  // AVS
  ...
  #else
    #define ADVANCE_K 0.00        // (mm) Compression length for all extruders. Override with 'M900 K<mm>'.   // AVS - handle K in g-code
  #endif
...
//#define CUSTOM_MENU_MAIN
  ...
  //#define MAIN_MENU_ITEM_6_IMMEDIATE          // AVS

  //#define MAIN_MENU_ITEM_7_DESC "Fan off"  // AVS
  //#define MAIN_MENU_ITEM_7_GCODE "M107"    // AVS
  //#define MAIN_MENU_ITEM_7_CONFIRM         // AVS
  //#define MAIN_MENU_ITEM_7_IMMEDIATE       // AVS
#endif
